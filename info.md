...
A Nest integration that uses the web api to work
...
This is caused by the fact that the Nest mobile app actually allows users to set the temperature in small
